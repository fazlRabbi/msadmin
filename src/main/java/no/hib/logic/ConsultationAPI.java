...
public class ConsultationAPI {
    ...
    public List<Appointment> getAllAppointments() {
        ...
        try {
            ...
            appointments = new Gson().fromJson(response.toString(), type);
        } catch (Exception ex) {
            throw new IllegalArgumentException("Exception getting all appointments: ", ex);
        }
        return appointments;
    }
    ...
    public List<Patient> getAllPatients() {
        ...
        try {
            ...
            List<Patient> tmp = new Gson().fromJson(response.toString(), type);
    ...
    public List<Doctor> getAllDoctors() {
        ...
        try {
            ...
            List<Doctor> tmp = new Gson().fromJson(response.toString(), type);
    ...
    public Settings getSettings() {
        ...
        try {
            ...
            settings = new Gson().fromJson(response.toString(), Settings.class);
    ...
    public Doctor getDoctor(String doctorSsn) {
        ...
        try {
            ...
            doctor = new Gson().fromJson(response.toString(), Doctor.class);
    ...
    public Appointment getAppointment(String uuid) {
        ...
        try {
            ...
            appointment = new Gson().fromJson(response.toString(), Appointment.class);
        } catch (Exception ex) {
    ...
    public void createOrUpdateAppointment(Appointment appointment) {
        try {
            ...
            wr.write(new Gson().toJson(appointment));
            wr.flush();
            wr.close();
    ...
    public void createOrUpdateDoctor(Doctor doctor) {
        try {
            ...
            wr.write(new Gson().toJson(doctor1));
            wr.flush();
            wr.close();
    ...
    public void createOrUpdatePatient(Patient patient) {
        try {
            ...
            wr.write(new Gson().toJson(patient1));
            wr.flush();
            wr.close();
    ...
    public void updateSettings(Settings settings) {
        try {
            ...
            wr.write(new Gson().toJson(settings1));
            wr.flush();
            wr.close();
    ...
    public void updateSymptom(Symptom newSymptom) {
        try {
            ...
            wr.write(new Gson().toJson(symptom));
            wr.flush();
            wr.close();
    ...
    public Symptom addNewSymptom(Symptom symptom) {
        ...
        try {
            ...
            wr.write(new Gson().toJson(symptom1));
            wr.flush();
            wr.close();
            ...
            created = new Gson().fromJson(response.toString(), Symptom.class);
    ...
    public void updateSubject(OtherSubject subject) {
        try {
            ...
            wr.write(new Gson().toJson(otherSubject));
            wr.flush();
            wr.close();
    ...
    public OtherSubject addNewSubject(OtherSubject subject) {
        ...
        try {
            ...
            created = new Gson().fromJson(response.toString(), OtherSubject.class);
